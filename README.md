...
1. Excecute `npm install` to get all the dependencies.
2. And run with `npm start`.
...
This app was initial created with [Create React App](https://github.com/facebook/create-react-app) here is its documentation.
